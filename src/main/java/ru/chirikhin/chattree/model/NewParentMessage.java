...
public class NewParentMessage extends BaseMessage {
    ...
    @Override
    byte[] bytes() {
        String serializedMessage = MessageType.NEW_PARENT.returnValue() + SEPARATOR_CHAR + getGlobalID() + SEPARATOR_CHAR + getNewParentIP() + SEPARATOR_CHAR + port + SEPARATOR_CHAR;
